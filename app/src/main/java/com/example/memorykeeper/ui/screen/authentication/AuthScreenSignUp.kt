...
fun AuthScreenSignUp(
    ...
    {
        Text(
            stringResource(R.string.selfora),
        ...
        Text(
            text = stringResource(R.string.sign_up_to_your_account), textAlign = TextAlign.Start,
            modifier = Modifier
                .fillMaxWidth()
                .padding(start = 32.dp),
        ...
        TextField(
            ...
            label = { Text(text = "Create User Name", style = MaterialTheme.typography.titleMedium) },
            modifier = Modifier
                .fillMaxWidth()
                .height(65.dp)
        ...
        Spacer(modifier = Modifier.padding(bottom = Dimens.paddingLarge))
        Button(
            onClick = { viewModel.signUp(email = uiState.email,
        ...
        when (uiState.authState) {
            is AuthUiState.Error -> Text(
                text = ((uiState.authState as AuthUiState.Error).message),
                color = Color.Red
            )
